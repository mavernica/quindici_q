...
List<CharacterClass> characters = [
  ...
  CharacterClass(name: "Ghandi", minTimeToGuess: 12, maxTimeToGuess: 16, specialResponses:[], mainCategory: "storia", buttonImage: "assets/waves/b3.json"),   //tra 12 e 16
  ...
  CharacterClass(name: "Darwin", minTimeToGuess: 4, maxTimeToGuess: 8, specialResponses:[], mainCategory: "storia", buttonImage: "assets/waves/b1.json"), //tra 4 e 8
  CharacterClass(name: "Tom Brady", minTimeToGuess: 1, maxTimeToGuess: 16, specialResponses:[], mainCategory: "sport", buttonImage: "assets/waves/blu3.json"), //tra 12 e 16
  ...
  CharacterClass(name: "Tiger Woods	", minTimeToGuess: 1, maxTimeToGuess: 8, specialResponses:[], mainCategory: "sport", buttonImage: "assets/waves/blu1.json"), //tra 4 e 8
];
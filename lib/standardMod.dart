...
class StandardMod extends StatefulWidget {
  final String team1;
  final String team2;
  ...
  @override
  State<StandardMod> createState() => _StandardModState();
}

class _StandardModState extends State<StandardMod> {
  ...
  Widget build(BuildContext context) {
    ...
    StandardModeClass game = StandardModeClass(
                ...
                child: Column(
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemCount: singleQuestion.questions.length,
  ...
  Widget myBottomNavBar(BuildContext context, StandardModeClass game) {
    return Row(
      children: [
        Material(
  ...
  Widget floatingButtons(StandardModeClass game) {
